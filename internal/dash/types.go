...
// From represents the source of a Dash transaction.
type From struct {
...
// To represents the destination of a Dash swap.
type To struct {
	Chain   common.Chain
	AssetID string
	Address string
...
// FeeProvider provides fee rate information for Dash.
type FeeProvider interface {
	SatsPerByte(ctx context.Context) (uint64, error)
}

// SwapProvider provides swap functionality for Dash.
